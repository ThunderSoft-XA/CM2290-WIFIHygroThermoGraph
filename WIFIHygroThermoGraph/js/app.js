...
//        console.log("onMessageArrived:" + message.payloadString + " qos: " + message.qos);
    ...
    'render': {
        ...
        'message': function (message) {
            ...
            //     '   </div>' +
            //     '</li>
            // alert(Encoder.htmlEncode(message.topic));
            // alert(Encoder.htmlEncode(message.payload));
            if ( Encoder.htmlEncode(message.topic) == "data/tem") {
                $("#temValue").html(Encoder.htmlEncode(message.payload) + '°C');
            } else if (Encoder.htmlEncode(message.topic) == "data/hum") {
                $("#humValue").html(Encoder.htmlEncode(message.payload) + '%');
            }
